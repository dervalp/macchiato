...
using Macchiato.Smoke.Test.ItemService;

namespace Macchiato.Speak.Smoke.Test.ItemService
{
    public class ItemServiceUpdateBehaviour : ItemServiceTest
    {
        private readonly ItemModel _item;
        private const string HomeItemPath = "sitecore/content/home";

        public ItemServiceUpdateBehaviour()
        {
            _item = new ItemModel
                {
                    {"ItemName", "Item Name"},
