...
// Credit to: https://github.com/ademargomes/JsonRequest/
...
namespace Sitecore.Speak.Smoke.Test
{
    ...
    public class Request
    {
        ...
        public object Execute<TT>(string url, object obj, string verb, string contentType)
        {
            Content = contentType;

            return Execute<TT>(url, obj, verb);
        }
        ...
        public object Execute<TT>(string url, object obj, string verb)
        {
            ...
            try
            {
                using (new ServerCertificateValidationScope(HttpRequest, delegate { return true; }))
                {
