!function(e){if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else{var o;"undefined"!=typeof window?o=window:"undefined"!=typeof global?o=global:"undefined"!=typeof self&&(o=self),o.SPEAKboot=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
},{"../exception":12,"./ast":5,"./base":6,"./javascript-compiler":8}],8:[function(require,module,exports){
"use strict";
...
var ComponentFactory = function ( adapterStore, baseComponent ) {
  ...
  return {
     ...
     */
    make: function ( adapt, def ) {
      var Component = baseComponent,
        init = def.initialize,
        proto = utils.extractProto( def );

      var adapter = adapterStore.find( adapt );

      if ( adapt ) {
        if ( adapter.make ) {
          //delegate construction to adapter
          return adapter.make( def );
        } else {

          if ( adapter.constructor !== {}.constructor ) {
            Component = adapter.constructor;
          }

          Component.prototype.initialize = ( adapter.initialize ) ? adapter.initialize : baseComp.prototype.initialize;
          Component.prototype.render = ( adapter.render ) ? adapter.render : baseComp.prototype.render;
          Component.prototype.serialize = ( adapter.serialize ) ? adapter.serialize : baseComp.prototype.serialize;
        }
      }

      return utils.inherits( Component, init, proto );
    }
  };
};

module.exports = ComponentFactory;
},{"../utils/index":39}],20:[function(require,module,exports){
...
},{"../model/store":29}],21:[function(require,module,exports){
var utils = require( "./utils/index" ),
    template = require( "./manager/template" ),
...
var isBrowser = typeof window !== "undefined",
    ...
    hasBeenCalled = root.__SPEAK_LOADED,
    ...
    baseComponent = require( "./model/component" )( pluginManager ),

    //Setup the componentFactory with the baseComponent and the adapterStore for later use
    componentFactory = require( "./factory/component" )( stores.adapter, baseComponent ),

    //Setup the component and application manager with the appropriates store and shared variable
    //we pass _s in order to have access to the public API later inside a Component
    componentManager = require( "./manager/component" )( stores.component, bootstrapValues, componentFactory, _s ),
    applicationManager = require( "./manager/app" )( stores.app, stores.pageCode );
...
_s.init = function ( cb ) {
    ...
    loader.load( stores, function () {
        ...
        applicationManager.start(
            ...
            pluginManager.initializeApplication,
            function ( tree, flat ) {
                if ( tree.length === 1 ) {
                    tree = tree[ 0 ];
                }
                _s.app = tree;
                _s.applications = flat;
                if ( cb ) {
                    cb( tree );
                }
                //TODO: trigger event + function ( ready ) + load:before +  load:after, + parser:before + parser:after,  
            }
        );
    } );
};
...
//Expose the Template engine to allow extension
_s.tmpl = template.tmp;

//make uniqueID accoss SPEAK
_s.uniqueId = utils.uniqueId;

_s.async = utils.async;
_s.attach = utils.attachScript;

//allow people to add adapters, plugins, pageCode and component
_s.adapter = stores.adapter.create.bind( stores.adapter );
_s.plugin = stores.plugin.create.bind( stores.plugin );
_s.component = stores.component.create.bind( stores.component );
_s.exposeComponent = componentManager.exposeComponent;
_s.pageCode = stores.pageCode.create.bind( stores.pageCode );
_s.extend = utils.extend;
_s.applyPlugins = pluginManager.initializeComponent;
_s.utils = utils;

utils.extend( _s, Events );
//extend template engine to support placeholder tag
//
//TODO: remove handlebars ?
_s.tmpl.registerHelper( "placeholder", function ( content ) {
    if ( !content ) {
        return "";
    }
...
if ( isBrowser ) {
    ...
    root.document.onreadystatechange = function () {
        if ( !deferred && !hasBeenCalled ) {
            _s.init( ready );
        }
    };
}

_s.ready = function ( callback ) {
    ready = callback;
};
...
module.exports = _s;
},{"./conf":18,"./factory/component":19,"./factory/store":20,"./loader/loader":22,"./manager/app":23,"./manager/component":24,"./manager/plugin":25,"./manager/template":26,"./model/component":27,"./parser/index":32,"./utils/events":38,"./utils/index":39,"modulejs":17}],22:[function(require,module,exports){
var utils = require( "../utils/index" );
...
var Loader = function ( conf ) {
  ...
  var loadAllComponents = function ( componentStore, callback ) {
    ...
    if ( keys.length ) {
      if ( useBundle ) {
        utils.attachScript( utils.buildModRequest( keys ), callback );
      } else {
        utils.async.each( componentStore.scripts(), utils.attachScript, callback );
      }
    } else {
      if ( callback ) {
        callback();
    ...
    loadPageCodesAndComponentDependencies = function ( pageCodeStore, componentStore, pluginStore, callback ) {
      var pageCodeKeys = pageCodeStore.scripts(),
        ...
        adapterStoreKeys = componentStore.deps(),
        all = [];

      all = all.concat( pageCodeKeys ).concat( adapterStoreKeys ).concat( pluginStoreKeys );

      load( all, callback );
    },
    loadPageCodePluginAdapterDependencies = function ( pageCodeStore, adapterStore, pluginStore, callback ) {
      var pageCodeKeys = pageCodeStore.deps(),
        adapterStoreKeys = adapterStore.deps(),
  ...
  return {
    ...
    load: function ( stores, callback ) {
      var self = this,
        componentStore = stores.component,
      ...
      loadAllComponents( componentStore, function () {
        loadPageCodesAndComponentDependencies( pageCodeStore, componentStore, pluginStore, function () {
          loadPageCodePluginAdapterDependencies( pageCodeStore, adapterStore, pluginStore, callback );
        } );
      } );
    }
  };
...
},{"../utils/index":39,"loaderJS":1}],23:[function(require,module,exports){
var utils = require( "../utils/index" ),
  PageCode = require( "../model/pageCode" ),
  appHelper = require( "../utils/app" ),
  Events = require( "../utils/Events" ),
  sortByDepth = utils.sortByDepth;

var AppManager = function ( applicationStore, pageCodeStore ) {
  ...
  var executePageCode = function ( app ) {

    var pageCode = pageCodeStore.find( app.key ),
      result;
    ...
    if ( pageCode ) {
      var P = utils.extendProto( PageCode, pageCode );
      result = new P( app );

      //need to replace reference to PageCode and not to app
  ...
  return {
     ...
     * @param  {Function} callback called when done
     */
    start: function ( createComponents, applyApplicationPlugin, callback ) {

      var apps = sortByDepth( flatten( applicationStore.stores ) ),
        exposed = [];

      apps.forEach( function ( app ) {
        createComponents( app );
        applyApplicationPlugin( app );
        exposed.push( executePageCode( app ) );
      } );
...
},{"../model/pageCode":28,"../utils/Events":36,"../utils/app":37,"../utils/index":39}],24:[function(require,module,exports){
var componentParser = require( "../parser/component" ),
  utils = require( "../utils/index" );

var ComponentManager = function ( componentStore, bootValues, componentFactory, _s ) {
  ...
  var getInitialValue = function ( comp, def ) {
    ...
    exposeComp = function ( comp, app ) {
      ...
      Component = componentFactory.make( def.adapter || comp.adapter, def );
      ...
      //TODO: remove dynamic - javascript Template
  ...
  return {
     ...
     */
    createComponents: function ( app ) {
      componentParser.parse( app.el ).forEach( function ( c ) {
        //TODO: put the subComp_ to CONF
        if ( c.id.indexOf( "subComp_" ) === -1 ) {
          exposeComp( c, app );
        }
      } );
      utils.createTree( app.components, "id" );
    }
  };
};

module.exports = ComponentManager;
},{"../parser/component":31,"../utils/index":39}],25:[function(require,module,exports){
...
//Handlesbar is our template Engine
var handlebars = require( "handlebars" ),
  utils = require( "../utils/index" );
...
},{"../utils/index":39,"handlebars":16}],27:[function(require,module,exports){
var utils = require( "../utils/index" ),
  DOM = require( "../utils/DOM" ),
  componentRegex = new RegExp( /\{\{component(.*?)\}\}/g ),
...
var SetupComponentModel = function ( pluginManager ) {
...
},{"../utils/DOM":35,"../utils/index":39}],28:[function(require,module,exports){
var utils = require( "../utils/index" );
...
},{"../utils/index":39}],29:[function(require,module,exports){
var utils = require( "../utils/index" );
 ...
 */
Store.prototype.create = function ( deps, obj ) {
  var self = this;
  ...
  this.stores[ obj.name ] = obj || {};
  this.stores[ obj.name ].deps;
...
/**
 * Metho which returns all the keys in the store
 * @return {Array} Array of string
 */
      ...
      if ( e.adapterScript ) {
        ...
        self.dependencies.forEach( function ( depsArray ) {
          depsArray.forEach( function ( dep ) {
            var depsLength = e.adapterScript.length;
            for ( var i = 0; i < depsLength; i++ ) {
              if ( e.adapterScript[ i ] === dep ) {
                exclude.push( i );
              }
            }
          } );
        ...
        exclude.forEach( function ( index ) {
          e.adapterScript.splice( index, 1 );
        } );
        if ( e.adapterScript.length > 0 ) {
          self.dependencies.push( e.adapterScript );
        }
      }
    }
  } );
...
},{"../utils/index":39}],30:[function(require,module,exports){
...
},{"../conf":18,"../utils/DOM":35}],31:[function(require,module,exports){
var conf = require( "../conf" ),
  utils = require( "../utils/index" ),
  DOMutils = require( "../utils/DOM" ),
...
var compAttributes = function ( el ) {
  var type = el.getAttribute( conf.TYPE ),
    ...
    adapterScript = el.getAttribute( conf.ADAPTER ),
  ...
  if ( adapterScript ) {
    deps = [ utils.removeFileExtensionIfNeeded( adapterScript ) ],
    adapter = adapterScript.substring( adapterScript.lastIndexOf( "/" ) + 1, ( adapterScript.length - 3 ) );
  }
  ...
  return {
    ...
    adapter: adapter ? adapter : void 0,
    adapterScript: deps ? deps : void 0
  };
};
...
var componentParser = {
  ...
  parse: function ( el ) {
    ...
    return utils.sortByDepth( els.map( compAttributes ) );
  }
};

module.exports = componentParser;
},{"../conf":18,"../utils/DOM":35,"../utils/index":39}],32:[function(require,module,exports){
...
var Parser = {
   ...
   */
  parse: function () {
    var allComponents = componentParser.parse(),
      allApplications = applicationParser.parse(),
      allPageCodes = pageCodeParser.parse(),
      allPlugins = pluginParser.parse();
...
},{"./app":30,"./component":31,"./pageCode":33,"./plugin":34}],33:[function(require,module,exports){
var conf = require( "../conf" ),
  utils = require( "../utils/index" ),
  DOMutils = require( "../utils/DOM" ),
  findParentApp = DOMutils.findParentApp,
  ...
  parse: function ( els ) {
    ...
    findPageCodes().forEach( function ( el ) {
      var parentApp = findParentApp( el ),
        script = utils.removeFileExtensionIfNeeded( el.getAttribute( "src" ) );
      //if no parentApp, we fallback to the body element
      if ( !parentApp ) {
        parentApp = document.body;
      }
      ...
      el.setAttribute( conf.ID, utils.uniqueId( "pageCode_" ) );
...
},{"../conf":18,"../utils/DOM":35,"../utils/index":39}],34:[function(require,module,exports){
var conf = require( "../conf" ),
  utils = require( "../utils/index" ),
  DOMutils = require( "../utils/DOM" ),
...
var pluginParser = {
  ...
  parse: function ( els ) {
    ...
    findPlugins().forEach( function ( el ) {
      var script = utils.removeFileExtensionIfNeeded( el.getAttribute( conf.SCRIPT ) );

      result.push( {
        el: el,
        key: el.getAttribute( conf.ID ),
        script: [ script ]
      } );
    } );
...
},{"../conf":18,"../utils/DOM":35,"../utils/index":39}],35:[function(require,module,exports){
var toArray = require( "./index" ).toArray,
  conf = require( "../conf" );
...
var DOMutils = {
   ...
   */
  findApps: function () {
    return toArray( document.querySelectorAll( conf.ATTR_APP ) );
  },
  /**
  ...
  findComponents: function ( el ) {
    ...
    return toArray( element.querySelectorAll( conf.ATTR_TYPE ) );
  },
  findPageCodes: function () {
    return toArray( document.querySelectorAll( conf.ATTR_PAGECODE ) );
  },
  findPageCode: function ( el ) {
    return el.querySelector( conf.ATTR_PAGECODE );
  },
  ...
  findParentComponent: function ( el ) {
    do {
      el = el.parentNode;
      if ( el.hasAttribute && el.hasAttribute( conf.TYPE ) ) {
        return el;
      }
      if ( el.hasAttribute && el.hasAttribute( conf.APP_KEY ) ) {
        return null;
...
},{"../conf":18,"./index":39}],36:[function(require,module,exports){
...
},{"./index":39}],37:[function(require,module,exports){
var utils = require( "../utils/index" );
...
},{"../utils/index":39}],38:[function(require,module,exports){
module.exports=require(36)
},{"./index":39}],39:[function(require,module,exports){
var conf = require( "../conf" );
...
var idCounter = 0,
  ...
  createTree = function ( flatArray, k ) {
    ...
    for ( var i = 0; i < number; i++ ) {
      ...
      if ( node.parent ) {
        var parent = flatArray[ map[ node.parent ] ];
        node.parent = parent;
        parent.children.push( node.PageCodeObject || node );
      } else {
